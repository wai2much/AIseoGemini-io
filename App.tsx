  ...
  return (
    <div className="min-h-screen bg-[#050505] text-zinc-300 overflow-y-auto selection:bg-[#00E676] selection:text-black" style={{ fontFamily: "'Roboto', 'Inter', sans-serif" }}>
      ...
      <section className="pt-28 pb-16 px-6 md:px-10 relative overflow-hidden">
        {/* Spline 3D Robot — centered background */}
        <motion.div
        ...
        >
          ...
          <div className="absolute inset-0 pointer-events-none" style={{ boxShadow: 'inset 0 0 150px 80px #050505' }} />
        </motion.div>

        <div className="max-w-5xl mx-auto text-center relative z-10 min-h-[85vh] flex flex-col justify-center">
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8, delay: 0.3 }} className="max-w-2xl mx-auto mb-6">
            <div className="flex gap-3 p-2 bg-[#0a0a0a]/80 backdrop-blur-sm border border-white/10 rounded-xl">
              <input
                type="text"
                value={roastUrl}
          ...
          <AnimatePresence>
            {roastResult && (
              <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0 }} className="max-w-2xl mx-auto mb-12">
                <div className="bg-[#0a0a0a]/90 backdrop-blur-sm border border-[#FF3D00]/30 rounded-xl p-6 text-left relative overflow-hidden">
          ...
          {/* STATS */}
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.6 }} className="flex justify-center gap-8 md:gap-16 flex-wrap">
